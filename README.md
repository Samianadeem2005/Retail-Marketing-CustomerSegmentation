...
![SQL](https://img.shields.io/badge/SQL-Analysis-pink)
![Status](https://img.shields.io/badge/Status-Completed-red)
...
8. [How to Use / Reproduce](#how-to-use--reproduce)
...
- **High_value customers (12% of base)** contribute **58% of total revenue**
- **Medium customers (35%)** show a **22% increase in purchase frequency** 
  when targeted with campaigns
- **42% of At-risk customers** had no purchases in the last 90 days

📈 **Campaign Performance**
- Campaign days generated **₹85K more revenue** compared to normal days 
  (April–June period)
- 30% discount campaigns drove **25% higher sales uplift** vs 10% discounts, 
  but with **lower profit margins of 8–10 percentage points**

🌍 **Geographic Insights**
- France and Germany account for **65% of total revenue**
- High_value customers are concentrated in **France (40%)** and **Germany (28%)**

🛒 **Channel & Product Performance**
- E-commerce and Mobile App contribute **72% of total revenue**
- Top 3 categories: T-shirts (**24%**), Dresses (**21%**), Shoes (**18%**)
...
![Country Share](visuals/Country_share.png)

### Customer Segmentation
![Customer Segmentation](visuals/Customer_segmentaion.png)
...
# Database Setup
CREATE DATABASE shopeasy_analytics;

#Import CSV files from Datasets/ folder into respective tables
